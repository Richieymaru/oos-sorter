 ...
 *
 * Idempotent: rerunning just refreshes the snapshot to the live statuses. The
 * same work is available in-app via the "Set up monitor" button (api/monitor-setup).
 */
